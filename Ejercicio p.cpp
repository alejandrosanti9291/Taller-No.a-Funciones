/*
Nombre: Escribe una funcion llamada mayor()que devuelva la fecha mas reciente
Autor: Alejandro Santibañez Sanchez
Fecha: 27/04/2017
Resumen: Escribe una funcion llamada mayor()que devuelva la fecha mas reciente
*/
#include<stdio.h>
